              ...
              <div class="card mb-4">
                 ...
                 <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                            <td>One Snider <span class='but'><button type="button" class="btn btn-outline-dark btn-sm">View Profile</button>
                                            ...
                                            <tr>
                                            <td>Blank <span class='but'><button type="button" class="btn btn-outline-dark btn-sm">View Profile</button>
                                            <button type="button" class="btn btn-outline-dark btn-sm">Status</button>
                                            <button type="button" class="btn btn-outline-dark btn-sm">Delete</button></span></td>
                                            </tr>
                                            <tr>
                                            <td>Donna Snider <span class='but'><button type="button" class="btn btn-outline-dark btn-sm">View Profile</button>
                                            <button type="button" class="btn btn-outline-dark btn-sm">Status</button>
                                            <button type="button" class="btn btn-outline-dark btn-sm">Delete</button></span></td>
                                            </tr>
                                            <tr>
